...
def run_bookflight():
    ...
    test_utils.measure('findSeats', lambda: client.service.findSeats('ANY', 'ANY', '2012-01-16T03:01:01.015Z', '2012-01-16T04:01:01.015Z', 1, 10))
    flight = 'RR6051'

    test_utils.measure('getPassengerList', lambda: client.service.getPassengerList(flight))
    ...
    test_utils.measure('bookSeat', lambda: client.service.bookSeat(False, bookingNumber, flight, passenger))
